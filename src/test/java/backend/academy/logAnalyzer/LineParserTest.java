...
class LineParserTest {
    ...
    public void testParseLogLine_CorrectLogLine() {
        ...
        Optional<LogRecord> logRecord = LineParser.parseLogLine(logLine);
    ...
    public void testParseLogLine_IncorrectLogLine_1() {
        Optional<LogRecord> logRecord = LineParser.parseLogLine("Invalid log line format");
        assertFalse(logRecord.isPresent());
    }

    @Test
    public void testParseLogLine_IncorrectLogLine_2() {
        Optional<LogRecord> logRecord = LineParser.parseLogLine("50.57.209.100 - - [03/Jun/2015:03:06:42 +0000] ");
        assertFalse(logRecord.isPresent());
    }
    ...
    public void testMakeRecordList_CorrectInput() throws IOException{
        ...
        assertEquals(1, analyze.getAddrAmount().get("79.136.114.202"));
        assertEquals(1, analyze.getAddrAmount().get("217.168.17.5"));
    }
    ...
    public void testMakeListOfRecords_Exception() throws IOException {
        ...
        reader.close();
        assertThrows(IOException.class, () -> LineParser.addRecord(reader, analyze));
    }
}
